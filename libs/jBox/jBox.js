...
function jBox(type, options) {
  ...
  this._create = function() {
    ...
    this.content = jQuery('<div/>', {'class': 'jBox-content'}).css({
      ...
      minWidth: this.options.minWidth, minHeight: this.options.minHeight, maxWidth: this.options.maxWidth, maxHeight: this.options.maxHeight}).appendTo(this.container);
